	...
	<form action="timeline-sports.php" method="POST">
		<div id="container" class="container">
			<header>
				...
				<h1 style="font-size: 50px;margin-top: 70px;margin-bottom: -80px;">SPORTS</h1> 
			</header>
			<hr id="header-line">
			<div class="main">
				<div>
				...
				<ul class="cbp_tmtimeline">
					<li>
						<?php 
						$query="SELECT * FROM sports ORDER BY favor_id DESC";
						$result=mysqli_query($connection,$query);
						if($result)
						{
							while($row=mysqli_fetch_assoc($result))
							{
								...
								<div class="cbp_tmlabel">
									...
									<p>
										<div class="baseline">
											<?php 
											$query_comments="SELECT * FROM sports_comments WHERE favor_id=$favor_id ORDER BY comment_id ASC";
...
if(isset($_POST['comment']))
{
	...
	echo "$comments";
	$query_insert_comment="INSERT INTO sports_comments(user_id,favor_id,comment,date,time) VALUES($current_user_id,$idButton,'$comments','$date','$time')";
