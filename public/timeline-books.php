	...
	<form action="timeline-books.php" method="POST">
		<div id="container" class="container">
			<header>
				...
				<h1 style="font-size: 50px;margin-top: 70px;margin-bottom: -80px;">BOOKS</h1> 
			</header>
			<hr id="header-line">
			<div class="main">
				<div>
				...
				<ul class="cbp_tmtimeline">
					<li>
						<?php 
						$query="SELECT * FROM books ORDER BY favor_id DESC";
						$result=mysqli_query($connection,$query);
						if($result)
						{
...
if(isset($_POST['comment']))
{
	...
	if($result_insert_comment)
	{
		...
		?>
		<script type="text/javascript">
			window.open ('timeline-books.php','_self',false);
		</script>
		<?php
	}
	else
