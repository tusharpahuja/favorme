(function($) {
  ...
  $.fn[pluginName] = function(options) {
    ...
    var i = 0;
    var valuesX = ['center','left','right'];
    var valuesY = ['center','up','down'];
  function varvaluesXY(){
    i++;
    if(i===3){
      i = 0;
    }
  ...
  setInterval(varvaluesXY , 5000);
  $.fn[pluginName].defaults = {
    minSpeedX: 0.1,
    maxSpeedX: 0.7,
    minSpeedY: 0.1,
    maxSpeedY: 0.7,
    directionX: valuesX[i], // 'center', 'left' or 'right'. 'center' = dots bounce off edges
    directionY: valuesY[i], // 'center', 'up' or 'down'. 'center' = dots bounce off edges
