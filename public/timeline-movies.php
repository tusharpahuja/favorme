...
<body>
	<form action="timeline-movies.php" method="POST">
		<div id="container" class="container">
			<header>
				...
				<h1 style="font-size: 50px;margin-top: 70px;margin-bottom: -80px;">MOVIES</h1> 
			</header>
			<hr id="header-line">
			<div class="main">
				<div>
							...
							while($row=mysqli_fetch_assoc($result))
							{
								...
								<div class="cbp_tmlabel">
									...
									<p>
										<div class="baseline">
											<?php 
											$query_comments="SELECT * FROM movies_comments WHERE favor_id=$favor_id ORDER BY comment_id ASC";
...
if(isset($_POST['comment']))
{
	...
	echo "$comments";
	$query_insert_comment="INSERT INTO movies_comments(user_id,favor_id,comment,date,time) VALUES($current_user_id,$idButton,'$comments','$date','$time')";
	...
	if($result_insert_comment)
	{
		...
		?>
		<script type="text/javascript">
			window.open ('timeline-movies.php','_self',false);
		</script>
		<?php
	}
	else
